...
void CalcIntegral(int argc, char **argv, unsigned int num_of_segments, unsigned int num_thds = 1000) {
  int rank, size;
  ...
  const unsigned int num_th = num_thds; // задаётся пользователем
...
int main(int argc, char **argv) {
  ...
  unsigned int num_thds = 1000;
  CalcIntegral(argc, argv, num_of_segments, num_thds);
  return 0;
}